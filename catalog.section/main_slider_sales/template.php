...
?><div id="sales-prod-slider" class="owl-carousel bx_catalog_list_home col<? echo $arParams['LINE_ELEMENT_COUNT']; ?> <? echo $templateData['TEMPLATE_CLASS']; ?>"><?
foreach ($arResult['ITEMS'] as $key => $arItem)
{
	...
	?><div class="<? echo ($arItem['SECOND_PICT'] ? 'bx_catalog_item double' : 'bx_catalog_item'); ?>"><div class="bx_catalog_item_container" id="<? echo $strMainID; ?>">
		<a id="<? echo $arItemIDs['PICT']; ?>" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" class="bx_catalog_item_images" style="background-image: url('<? echo $arItem['PREVIEW_PICTURE']['SRC']; ?>')" title="<? echo $imgTitle; ?>">
			<div class="r_stick">
				<?
				if (!empty($arItem['R_STICKERS']['SPECIALOFFER']))
					echo '<div class="r_stick-spec"></div>';
				if (!empty($arItem['R_STICKERS']['NEWPRODUCT']))
					echo '<div class="r_stick-new"></div>';
				if (!empty($arItem['R_STICKERS']['SALELEADER']))
	...
	<div class="bx_catalog_item_price">
		...
		?>
		<div id="<? echo $arItemIDs['PRICE']; ?>" class="<?= $sale_price ? 'bx_price_sale': 'bx_price'?>">
			<?

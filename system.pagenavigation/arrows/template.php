...
if (!isset($arParams['PAGE_ELEMENT_COUNT'])) {
	$arParams['PAGE_ELEMENT_COUNT'] = $arResult['NavPageSize'];
}

// var_dump($arResult);//die();
// var_dump($arParams['PAGE_ELEMENT_COUNT']);die();
...
?>
				...
				<span class="bx_pg_text">Выводить по:</span>
				<ul id="limiter">
				<?if ($arResult["bShowAll"]):
					...
					<?else:?>
						<li><a class="nav-page-limit <?if ($arParams['PAGE_ELEMENT_COUNT'] == 20) echo'selected';?>" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>limit=20">20</a></li>
						<li><a class="nav-page-limit <?if ($arParams['PAGE_ELEMENT_COUNT'] == 40) echo'selected';?>" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>limit=40">40</a></li>
						<li><a class="nav-page-limit <?if ($arParams['PAGE_ELEMENT_COUNT'] == 100) echo'selected';?>" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>limit=100">100</a></li>
